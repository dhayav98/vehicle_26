...
public class Displayvehicle extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(Vehicle vv:list)
		{
			out.print("<tr><td>"+vv.getVehicleno()+"</td><td>"+vv.getVehicletype()+"</td><td>"+vv.getBranch()+"</td><td>"+vv.getInsurance_expiry()+"</td><td>"+vv.getLast_serviced_date()+"</td><td>"+vv.getService_due_date()+"</td></tr>");
		}
		out.print("</table>");
		out.print("<br>");
