...
public class Createvehicle extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String branch=request.getParameter("vtype");
		String vehicletype=request.getParameter("branch");
		
//		DateFormat df= new SimpleDateFormat("yyyy-mm-dd");
//		
//		java.sql.Date insurance_expiry=(Date) df.parse(request.getParameter("insurance"));
//		java.sql.Date service_due_date=(Date) df.parse(request.getParameter("serviceduedate"));
//		java.sql.Date last_serviced_date=(Date) df.parse(request.getParameter("lastserviceddate"));
